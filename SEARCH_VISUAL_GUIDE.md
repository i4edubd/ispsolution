...
│  👥 Customers (3)                                           │
│  ┌─────────────────────────────────────────────────────┐   │
│  │ Name    Email         Username  Mobile  Status     │   │
│  │ John D  john@ex.com   johnd     +123    🟢 Active  │   │
│  │ Johnny  johnny@...    johnny    +456    🟢 Active  │   │
│  └─────────────────────────────────────────────────────┘   │
│                                                             │
├─────────────────────────────────────────────────────────────┤
│  📄 Invoices (2)                                            │
...
```
┌────────────────────────────────────────────────────────────────────┐
│ Name      │ Email        │ Username │ Mobile    │ Package │ Status │
├────────────────────────────────────────────────────────────────────┤
│ John Doe  │ john@ex.com  │ johnd    │ +12345... │ Premium │ Active │
│ Jane S.   │ jane@ex.com  │ janes    │ +67890... │ Basic   │ Active │
│ Bob W.    │ bob@ex.com   │ bobw     │ N/A       │ No Pkg  │ Inactive│
└────────────────────────────────────────────────────────────────────┘
```

### Additional Info (for Super Admin/Developer)
```
┌─────────────────────────────────────────────────────────────────────────┐
...
```
┌──────────────────────────────────────────────────────────────────────┐
│ Invoice # │ Customer  │ Email/Mobile    │ Amount  │ Due Date │ Status │
├──────────────────────────────────────────────────────────────────────┤
...
- **Super Admin/Admin/Manager/Accountant**: ✅ View available
- **Operator/Sub-Operator/Staff**: ❌ N/A (no view route)
- **Customer**: ❌ N/A (no access)

### Invoice View Links
- **All Higher Roles**: ✅ View invoice details
- **Customer**: ✅ View own invoice only
- Links open appropriate view page based on role
...
3. **Search by Mobile**: Enter "1234" → Should find matching mobiles
