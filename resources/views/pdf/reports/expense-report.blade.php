    ...
    <div class="container">
        ...
        <div class="header">
            ...
            <div class="report-title">
                ...
                <p>Detailed Business Expenses</p>
            </div>
        </div>
        ...
        <div class="summary-section">
            <div class="summary-card">
                ...
                <div class="amount">৳ {{ number_format($summary['total_expenses'] ?? 0, 2) }}</div>
            </div>
            <div class="summary-card">
                <h3>Total Items</h3>
            ...
            <div class="summary-card">
                ...
                <div class="amount">৳ {{ number_format($summary['average_expense'] ?? 0, 2) }}</div>
            </div>
        </div>
        ...
        <table>
            ...
            <tbody>
                @forelse($expenses as $expense)
                    <tr>
                        <td>{{ $expense->date ?? now()->format('Y-m-d') }}</td>
                        ...
                        <td>{{ ucfirst($expense->status ?? 'paid') }}</td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="7" class="text-center">No expenses found for this period</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
