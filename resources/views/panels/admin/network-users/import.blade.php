...
document.getElementById('importForm')?.addEventListener('submit', function(e) {
    ...
    if (!routerId) {
        e.preventDefault();
        alert('Please select a router to import from');
        return;
    }
    
    if (!confirm('Are you sure you want to start the import? This may take a few minutes depending on the number of users.')) {
        e.preventDefault();
    }
});
</script>
