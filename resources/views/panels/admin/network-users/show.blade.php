        ...
        <div class="p-6">
            <div class="flex justify-between items-center">
                ...
                <div class="flex space-x-2">
                    <a href="{{ route('panel.admin.network-users.edit', $networkUser->id) }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 focus:bg-indigo-700 active:bg-indigo-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
    ...
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6">
            ...
            <div class="flex space-x-3">
                <form action="{{ route('panel.admin.network-users.destroy', $networkUser->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this network user?');">
                    @csrf
                    @method('DELETE')
