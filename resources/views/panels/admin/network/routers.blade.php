...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-gray-100">Network Routers</h1>
                    <p class="mt-2 text-gray-600 dark:text-gray-400">Manage all network routers - MikroTik, Cisco, and more</p>
                </div>
    ...
    <x-router.device-tabs activeTab="mikrotik" />
