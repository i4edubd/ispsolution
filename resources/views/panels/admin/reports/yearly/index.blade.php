    ...
    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg hover:shadow-lg transition-shadow duration-300">
            <div class="p-6">
                ...
                <a href="{{ route('panel.admin.yearly-reports.card-distributor-payments') }}" 
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg hover:shadow-lg transition-shadow duration-300">
            <div class="p-6">
                ...
                <a href="{{ route('panel.admin.yearly-reports.cash-in') }}" 
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg hover:shadow-lg transition-shadow duration-300">
            <div class="p-6">
                ...
                <a href="{{ route('panel.admin.yearly-reports.cash-out') }}" 
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg hover:shadow-lg transition-shadow duration-300">
            <div class="p-6">
                ...
                <a href="{{ route('panel.admin.yearly-reports.operator-income') }}" 
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg hover:shadow-lg transition-shadow duration-300">
            <div class="p-6">
                ...
                <a href="{{ route('panel.admin.yearly-reports.expenses') }}" 
