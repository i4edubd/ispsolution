        ...
        <div class="p-6">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="mt-2 text-gray-600 dark:text-gray-400">View all sent SMS messages and their delivery status</p>
                </div>
                <div class="flex space-x-2">
                    <a href="{{ route('panel.admin.sms.send') }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700 focus:bg-indigo-700 active:bg-indigo-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150">
            ...
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">Total Sent</dt>
                            <dd class="text-2xl font-semibold text-gray-900 dark:text-gray-100">12,456</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-2xl font-semibold text-gray-900 dark:text-gray-100">11,890</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-2xl font-semibold text-gray-900 dark:text-gray-100">123</dd>
                        </dl>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">Total Cost</dt>
                            <dd class="text-2xl font-semibold text-gray-900 dark:text-gray-100">$622</dd>
                        </dl>
                    </div>
                </div>
            </div>
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 gap-4 sm:grid-cols-5">
                <div>
                    ...
                    <input type="text" placeholder="Search recipient..." class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="date" class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                </div>
                <div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        @php
                            $sampleData = [
                                ['recipient' => 'John Doe', 'phone' => '+1234567890', 'message' => 'Your payment of $50 has been received. Thank you!', 'gateway' => 'Twilio', 'status' => 'delivered', 'sent_at' => '2024-01-15 10:30:25', 'cost' => '$0.05'],
                                ['recipient' => 'Jane Smith', 'phone' => '+1234567891', 'message' => 'Reminder: Your bill of $45 is due on Jan 20, 2024', 'gateway' => 'Nexmo', 'status' => 'delivered', 'sent_at' => '2024-01-15 09:15:10', 'cost' => '$0.05'],
                                ['recipient' => 'Bob Johnson', 'phone' => '+1234567892', 'message' => 'Welcome to our ISP service! Your account is now active.', 'gateway' => 'Twilio', 'status' => 'sent', 'sent_at' => '2024-01-15 08:45:30', 'cost' => '$0.05'],
                                ['recipient' => 'Alice Williams', 'phone' => '+1234567893', 'message' => 'Maintenance scheduled for tonight 11 PM - 2 AM', 'gateway' => 'Local', 'status' => 'failed', 'sent_at' => '2024-01-14 18:20:15', 'cost' => '$0.00'],
                                ['recipient' => 'Charlie Brown', 'phone' => '+1234567894', 'message' => 'Your package has been upgraded to Premium 50 Mbps', 'gateway' => 'Twilio', 'status' => 'pending', 'sent_at' => '2024-01-14 16:10:00', 'cost' => '$0.05'],
                            ];
                        @endphp
                        @forelse($sampleData as $sms)
                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-700">
                                <td class="px-6 py-4">
                                    <div class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ $sms['recipient'] }}</div>
                                    <div class="text-sm text-gray-500 dark:text-gray-400">{{ $sms['phone'] }}</div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="text-sm text-gray-900 dark:text-gray-100 max-w-xs truncate">{{ $sms['message'] }}</div>
                                </td>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    ...
                                    @if($sms['status'] === 'failed')
                                        <button class="text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300">Retry</button>
                                    @endif
                                </td>
                            </tr>
                        @empty
                            <tr>
                                <td colspan="7" class="px-6 py-12 text-center">
                                    ...
                                    <p class="mt-2 text-gray-500 dark:text-gray-400">No SMS history found.</p>
                                    <p class="text-sm text-gray-400 dark:text-gray-500">Start sending SMS to see history here.</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
