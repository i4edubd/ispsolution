        ...
        <div class="p-6 text-gray-900 dark:text-gray-100">
            <div class="flex justify-between items-center">
                ...
                <div class="flex space-x-2">
                    <a href="{{ route('panel.admin.mikrotik.configure.show', $router->id) }}" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700">
                        Configure
                    </a>
                    <a href="{{ route('panel.admin.network.routers.edit', $router->id) }}" class="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700">
                        Edit Router
                    </a>
                </div>
            </div>
    ...
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <a href="{{ route('panel.admin.mikrotik.import.index') }}" class="inline-flex items-center justify-center px-4 py-3 bg-blue-50 dark:bg-blue-900 border border-blue-200 dark:border-blue-700 rounded-md hover:bg-blue-100 dark:hover:bg-blue-800">
                ...
                <a href="{{ route('panel.admin.mikrotik.configure.show', $router->id) }}" class="inline-flex items-center justify-center px-4 py-3 bg-green-50 dark:bg-green-900 border border-green-200 dark:border-green-700 rounded-md hover:bg-green-100 dark:hover:bg-green-800">
                ...
                <a href="{{ route('panel.admin.logs.router') }}" class="inline-flex items-center justify-center px-4 py-3 bg-purple-50 dark:bg-purple-900 border border-purple-200 dark:border-purple-700 rounded-md hover:bg-purple-100 dark:hover:bg-purple-800">
                ...
                <a href="{{ route('panel.admin.network.routers.edit', $router->id) }}" class="inline-flex items-center justify-center px-4 py-3 bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-md hover:bg-gray-100 dark:hover:bg-gray-600">
...
document.getElementById('test-connection').addEventListener('click', function() {
    ...
    fetch('{{ route('panel.admin.network.routers.test-connection', $router->id) }}', {
        method: 'POST',
        headers: {
