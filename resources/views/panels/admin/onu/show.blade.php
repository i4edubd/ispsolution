        ...
        <div class="p-6">
            <div class="flex justify-between items-center">
                ...
                <div class="flex space-x-2">
                    <a href="{{ route('panel.admin.network.onu.index') }}" class="inline-flex items-center px-4 py-2 bg-gray-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700">
                        Back to List
                    </a>
                    <a href="{{ route('panel.admin.network.onu.edit', $onu) }}" class="inline-flex items-center px-4 py-2 bg-indigo-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-700">
                        Edit
                    </a>
                </div>
            </div>
                    ...
                    <dl class="space-y-3">
                        <div>
                            ...
                            <dd class="mt-1 text-sm text-gray-900 dark:text-gray-100">
                                <a href="{{ route('panel.admin.customers.show', $onu->networkUser->id) }}" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300">
