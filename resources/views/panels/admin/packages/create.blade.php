                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-3">
                        <div>
                            ...
                            <input type="text" name="speed" id="speed" value="{{ old('speed') }}" placeholder="e.g., 10 Mbps" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-100 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            @error('speed')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
