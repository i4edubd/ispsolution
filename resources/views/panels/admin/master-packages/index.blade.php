...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6">
            <form method="GET" action="{{ route('panel.admin.master-packages.index') }}" class="space-y-4">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                    ...
                    <div class="flex gap-2">
                        ...
                        <a href="{{ route('panel.admin.master-packages.index') }}" class="px-4 py-2 bg-gray-300 text-gray-700 rounded-md hover:bg-gray-400">Clear</a>
                    </div>
                </div>
            </form>
        </div>
            ...
            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead class="bg-gray-50 dark:bg-gray-700">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Customers</th>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="flex items-center">
                                    ...
                                    <span class="ml-1 text-xs text-gray-500 dark:text-gray-400" title="Cached count (updated every 2.5 minutes)">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                <a href="{{ route('panel.admin.master-packages.show', $package) }}" class="text-indigo-600 hover:text-indigo-900">View</a>
                                <a href="{{ route('panel.admin.master-packages.edit', $package) }}" class="text-blue-600 hover:text-blue-900">Edit</a>
                                @if($package->canDelete())
                                    <form action="{{ route('panel.admin.master-packages.destroy', $package) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
