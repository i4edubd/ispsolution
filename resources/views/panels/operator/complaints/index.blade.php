        ...
        <div class="p-6 text-gray-900 dark:text-gray-100">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="mt-2 text-gray-600 dark:text-gray-400">Customer complaints and support tickets</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6">
            ...
            <div class="text-center py-12">
                ...
                <h3 class="mt-2 text-sm font-medium text-gray-900 dark:text-gray-100">No complaints</h3>
                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    No customer complaints or support tickets at this time.
                </p>
            </div>
            @else
