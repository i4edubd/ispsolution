        ...
        <div class="lg:col-span-2">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    ...
                    <form method="POST" action="{{ route('api.sms-payments.store') }}" id="smsPaymentForm" class="space-y-6">
                        @csrf
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateSummary() {
        ...
        submitBtn.disabled = quantity < 100 || !document.querySelector('input[name="payment_method"]:checked');
    }

    // Enable submit when payment method is selected
    ...
    form.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            if (result.success) {
                ...
                window.location.href = '{{ route("panel.sms-payments.index") }}';
            } else {
