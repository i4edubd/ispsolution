...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 text-gray-900 dark:text-gray-100">
            ...
            <p class="mt-2 text-gray-600 dark:text-gray-400">Record payment from your assigned customer</p>
        </div>
    </div>
        ...
        <div class="p-6">
            <form method="POST" action="#" class="space-y-6">
                ...
                <div class="flex justify-end">
                    <a href="{{ route('panel.sub-operator.dashboard') }}" class="mr-3 inline-flex justify-center py-2 px-4 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-600">
                        Cancel
                    </a>
