    ...
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="p-6 text-gray-900 dark:text-gray-100">
            <div class="flex justify-between items-center">
                <div>
                    <h1 class="text-3xl font-bold">Customer Bills</h1>
                    <p class="mt-2 text-gray-600 dark:text-gray-400">Bills for your assigned customers</p>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                ...
                                @if($bill->status !== 'paid')
                                <a href="{{ route('panel.sub-operator.payments.create') }}" class="text-green-600 hover:text-green-900 dark:text-green-400 dark:hover:text-green-300">Collect</a>
                                @endif
                            </td>
                        </tr>
                        @empty
                        <tr>
                            <td colspan="6" class="px-6 py-4 text-center text-sm text-gray-500 dark:text-gray-400">
                                No bills found for your customers.
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
